...
**Ships now (G0):** the regolith state and genesis derivation from existing fields (slope, water, flora, climate); frost/heat weathering, wash along `drains_to`, roots/rot, winnowing; derived live fertility wired into cultivation and the inspector; composition-colored terrain; describe lines. **Landed since:** cultivation depletion and fallow recovery (the plow mineralizes organic; roots rebuild it); dunes and loess (winnowed fines hop downwind — bare ground piles sand, green ground traps new soil); landslides on oversteep scree; and the burial rules made honest — silt spares the living soil, rubble and sand do not. **Still queued:** elevation actually lowering under sustained erosion (the [26] W1 slot — needs live re-derivation of drainage); extraction verbs when the grammar or works need them ([29](29-the-underground.md) holds the columns they will bid against).
